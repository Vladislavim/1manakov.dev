...
export default function AboutPage() {
  return <main id="main" tabIndex={-1}>
    <CaseMotion><section className="about-page"><div className="about-top" data-case-reveal><span className="eyebrow">A LITTLE CONTEXT.</span><span className="eyebrow">DESIGN + FRONTEND</span></div>
