...
export async function generateMetadata({params}:Props){const{page}=await params;return{title:`Практика дизайна: страница ${page}`,alternates:{canonical:`/guides/page/${page}`}};}
