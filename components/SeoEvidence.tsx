...
export function SeoEvidence({result:r}:{result:SeoResult}){
 ...
 return <section ref={root} className="seo-evidence" aria-labelledby="seo-evidence-title">
  ...
  <aside className="seo-later"><div><span className="eyebrow">LATER MEASUREMENT</span><p className="seo-later-share">15.3% <span>organic traffic</span></p></div><div><p>Organic search remained a meaningful acquisition channel in a later measurement period.</p><p>169 search visits / 1,107 total visits · Jun–Aug 2026</p><a className="text-link" href="/images/evidence/allnrg/metrica-jun-aug-2026.pdf" target="_blank" rel="noreferrer">VIEW LATER REPORT ↗</a></div></aside>
